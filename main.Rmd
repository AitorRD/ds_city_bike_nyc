...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      tags$div(style = "margin-top: 20px; padding: 10px; background: white; border-radius: 5px; box-shadow: 2px 2px 10px rgba(0,0,0,0.2); max-width: 300px;",
        tags$h4("Aviso con poner 'Todos' en los inputs (puede dejar de verse el mapa por falta de potencia)", style = "margin-top: 0; margin-bottom: 10px;"))
    ),
      mainPanel(
